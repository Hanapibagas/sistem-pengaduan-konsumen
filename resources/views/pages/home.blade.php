        ...
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <div class="sol-img m-mt30">
                    <img style="width: 80%" src="{{ asset('frontend/images/survie/team-business.jpg') }}" alt="survei"
                        class="img-fluid">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="pera-block ml50">
                    ...
                    <p style="font-size: 15px">Pemerintah berupaya meningkatkan kualitas pelayanan masyarakat demi
                        tercapainya harapan dan tuntutan publik sesuai Keputusan Menteri Pendayagunaan Aparatur Negara
                        Nomor 14 Tahun 2017 tentang Pedoman Umum Penyusunan Survei Kepuasan Masyarakat Unit
                        Penyelenggara Pelayanan Publik. Mengacu pada hal tersebut, maka Tim Survei dan Pengolah Data
