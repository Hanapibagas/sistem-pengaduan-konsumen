<div style="width: auto; height: auto; border: 1px solid;">
    <div style="margin-top: 0px">
        <img src="{{('frontend/images/logo.png') }}" style="width: 50px; margin-left: 330px; margin-top: 10px" alt="" srcset="">
      ...
      <p style="text-align: center; margin-top: -23px">jl.Manunggal 22 No. 40 Maccini Sombala, Tamalate Telp.0411-8917345 Makassar 90224</p>
    ...
    <div style="margin-left: 5%;">
      ...
      <table>
        ...
        <tr>
          <td>1. Nama Pelaku Usaha</td>
          <td>:</td>
          <td>{{ $laporanpengaduan->diadukan->nama_pelaku_usaha }}</td>
        </tr>
        <tr>
          <td>2. Alamat</td>
          <td>:</td>
      ...
      <table>
        ...
        <tr>
          ...
          <td>:</td>
          <td>{{ $laporanpengaduan->jenis_tuntutan->jenis_tuntutan }}</td>
        </tr>
        <tr>
    ...
    <div style="display: flex; margin-left: 15%;">
      <div style="margin-left: 2%">
        ...
        <p style="margin-left: -20px">........................... <span style="margin-left: 40%">.........................</span></p>
      </div>
    </div>
