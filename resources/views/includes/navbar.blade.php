        ...
        <div class="container">
            <div class="navbar-header">
                ...
                {{-- <div class="navbar-brand"> --}}
                    <img class="img img-responsive" style="width: 180px; margin-top: 8px"
                        src="{{ asset('frontend/images/Logo Disdag-hitam.png') }}"></a>
                    {{--
                </div> --}}
            </div>
            ...
            <div class="navbar-collapse collapse">
                <div class="menu">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="{{ route('kebijakan-index') }}">Kebijakan</a></li>
                        <li role="presentation"><a href="{{ route('tata-cara-pengaduan.index') }}">Tata Cara
                                Pengaduan</a></li>
                        @guest
